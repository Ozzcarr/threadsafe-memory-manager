...
// void my_assert_impl(int condition, const char *test_name, const char *file,
// int line, const char *assertion)
// {
//     if (!condition)
//     {
//         printf_red("[FAIL] - %s (Assertion '%s' failed at %s:%d.)\n",
//         test_name, file, line); exit(EXIT_FAILURE); // Optionally exit the
//         program
//     }
//     else
//     {
...
// #define my_assert(condition, test_name) my_assert_impl(condition, test_name,
